...
int main(const int argc, char* argv[])
{
	...
	{
		printf("[HELP] Anya-Injector.exe <dll file> <process name>\n");
		return -1;
	}
	...
	{
		printf("[!] An error has occured when trying to find the target process!\n");
		return -1;
	}
	printf("[ANYA-INJECTOR]\n");
	printf("Process : %s \n", lpProcessName);
	printf("Process ID : %i\n\n", (int)dwProcessID);
	...
	{
		printf("[!] An error has occured when trying to get the full path of the DLL!\n");
		return -1;
	}
	...
	{
		printf("[!] An error has occured when trying to open the target process!\n");
		return -1;
	}
	...
	{
		printf("[!] An error has occured when trying to allocate memory in the target process!\n");
		return -1;
	}
	...
	if (dwWriteResult == 0)
	{
		printf("[!] An error has occured when trying to write the DLL path in the target process!\n");
		return -1;
	}
	printf("DLL path writeen successfully!\n");
	...
	{
		printf("[!] An error has occured when trying to get \"LoadLibraryA\" address!\n");
		return -1;
	}
	...
	{
		printf("[!] An error has occured when trying to create the thread in the target process!\n");
		return -1;
	}
	printf("DLL Injected!\n");
